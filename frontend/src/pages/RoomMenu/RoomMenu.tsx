...
export default function RoomMenu({ onJoin, onPlayDemo, onPlaySolo }: RoomMenuProps) {
  ...
  return (
    <div className="menu-backdrop">
      <div className="menu-card">
        ...
        <button className="menu-secondary-button" type="button" onClick={onPlaySolo}>
          Play Solo (real game, no opponent needed)
        </button>
